...
function RelatorioSemanal() {
    ...
    const titulo = `Relatório Semanal${getSetorAtual() ? ` — ${getSetorAtual().nome}` : ""}`;
    ...
    const imprimirRelatorio = () => {
        const tabela = document.querySelector(".area-impressao");
    ...
    return (
        <div className="container-fluid mt-4">
            ...
            {!loading && dadosRelatorio.dias && (

                <div className="table-responsive mt-4 area-impressao">
                    ...
                    <div className="mt-4">
                        ...
                        <table className="table table-bordered">
                            ...
                            <tbody>
                                ...
                                {resumoFuncionarios.map((funcionario, index) => (
